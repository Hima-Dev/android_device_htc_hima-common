...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/mixer_paths_i2s.xml:system/etc/mixer_paths_i2s.xml \
    $(LOCAL_PATH)/configs/aanc_tuning_mixer.txt:system/etc/aanc_tuning_mixer.txt \
    $(LOCAL_PATH)/configs/audio_platform_info_i2s.xml:system/etc/audio_platform_info_i2s.xml \
